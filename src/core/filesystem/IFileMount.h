...
public:
    ...
    [[nodiscard]] virtual bool isDirectory(std::string_view relativePath) const = 0;
    [[nodiscard]] virtual std::optional<FileStat> stat(std::string_view relativePath) const = 0;
    ...
    [[nodiscard]] virtual bool writeBinaryAtomic(std::string_view relativePath,
                                                 std::span<const std::byte> data) = 0;
